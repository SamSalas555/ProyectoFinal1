<?php
 $conect = mysqli_connect('localhost','root','','registroscendi') or die("Error de conectividad con el servidor");
 ...
 ";
 $sql ="INSERT INTO nino (apPatN,apMatN,nombreN,fnac,curpN,imagen,folio,nemp,cendi,ciclo)
 VALUES ('$apePaterno','$apeMaterno','$nombre','$fechaNacimiento','$curp','','$boleta',
 '$noEmp','$cendi','$cicloEscolar')";
...
'$noExt','$noIntCon','$colonia','$municipio','$entidad','$cp','$telFijo','$telCel','$correo'
,'$ocupacion','$curpDH','$puesto','$sueldo','$noEmp','$adscripcion','$horario','$ext','','')";
  ...
  if($conyuge == "si"){
    ...
    $sql3 = "INSERT INTO conyuge (apPatC,apMatC,nombreC,trabajocon,callecon,numExtcon,numIntcon
    ,coloniacon,municipiocon,teltrab,ext,curpcon,nemp) VALUES ('$apeMaternoCon','$apeMaternoCon',
    '$nombreCon','$trabajoCon','$calleTraCon','$noExtCon','$noIntCon','$coloniaCon','$municipioCon',
    '$telTrabajoCon','$extensionCon','$curpCon','$noEmp')";

    $resultado3 = mysqli_query($conect,$sql3) or die ("Error base de datos");
 }else{ 
     $sql4 = "INSERT INTO conyuge (apPatC,apMatC,nombreC,trabajocon,callecon,numExtcon,numIntcon
     ,coloniacon,municipiocon,teltrab,ext,curpcon,nemp) VALUES ('','','','','','','','','',
     '','','',$noEmp)";
    $resultado4 = mysqli_query($conect,$sql4) or die ("Error base de datos"); 
 }
